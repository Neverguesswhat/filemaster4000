...
import { BoldIcon, ItalicIcon, StrikethroughIcon, CodeBracketIcon, ListBulletIcon, QueueListIcon, ChatBubbleBottomCenterTextIcon, MinusIcon, SparklesIcon, ArrowPathIcon, TableCellsIcon, ArrowDownTrayIcon, MapPinIcon } from '@heroicons/react/24/outline';
import { H1Icon, H2Icon, PhotoIcon } from '@heroicons/react/24/outline';
import { supabase } from '@/integrations/supabase/client';
import { toast } from 'sonner';
import { AISummaryPanel } from './AISummaryPanel';
import { TableToolbar } from './TableBubbleMenu';
...
export function NoteEditor({ note, onUpdateTitle, onUpdateContent, onAddMedia, onTogglePin, confirmDeleteAiChat, confirmDeleteTable, isRecording }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col h-screen overflow-hidden">
      {/* Toolbar */}
      <div className="flex items-center gap-0.5 pl-6 pr-6 h-[41px] border-b border-border bg-background sticky top-0 z-10">
        <ToolbarButton
